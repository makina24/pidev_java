...
public class sController implements Initializable {
   private Connection con = (Connection) Connexion.getInstance().getConnection();

 private TicketService serv = new TicketService();
   @FXML
    private Button pdf;
    ...
    public void initialize(URL url, ResourceBundle rb) {
         String req =" SELECT nomPlat,date from ticket ";
